...
**Reinstall shortcut:** `pnpm electron:reinstall` (or `/electron-reinstall` in Claude Code) — kills running app, deletes old install, opens .dmg. User still drags to Applications.
