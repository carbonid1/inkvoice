...
export const AddBookCard = ({ onUpload, uploading }: AddBookCardProps) => {
  ...
  return (
    <div
      ...
      className="h-full flex flex-col p-4 border-2 border-dashed border-gray-300 dark:border-gray-600 rounded-lg hover:border-blue-400 dark:hover:border-blue-500 transition-colors cursor-pointer bg-white dark:bg-gray-800"
    >
      <div className="w-full aspect-[2/3] rounded mb-3 flex flex-col items-center justify-center gap-2">
        {uploading ? (
          ...
          <>
            ...
            <span className="text-sm text-gray-400 dark:text-gray-500">Add Book</span>
          </>
        )}
      </div>
      <input
