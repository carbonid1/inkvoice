  ...
  return (
    <div className="relative" ref={containerRef} onKeyDown={handleKeyDown}>
      ...
      {open && (
        <ul
          role="listbox"
          className={`absolute z-50 mt-1 min-w-full w-max max-w-xs bg-white dark:bg-gray-800 border border-gray-200 dark:border-gray-700 rounded-lg shadow-lg max-h-60 overflow-y-auto ${menuClassName ?? ''}`}
        >
